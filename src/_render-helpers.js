...
function drawFloor(i, j, fSectorFloorHeight, sSectorFloorTexture, currentSector, floorSlopeFactor){
  ...
  fPlayerHinSector = fSectorFloorHeight * floorSlopeFactor;
  ...
  //   var slopeAtthisPoint = floorSlopeFactor;
